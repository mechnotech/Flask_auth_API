...
Revision ID: 256dd0d6b5ad
Revises: 
Create Date: 2021-12-20 15:15:27.500352
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['user_id'], ['users.id'], name=op.f('fk__profiles__user_id__users'), ondelete='CASCADE'
        ),
